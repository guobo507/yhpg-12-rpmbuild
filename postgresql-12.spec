...
Patch4:		%{sname}-%{pgmajorversion}-yhpg-config.patch
...
%pre server
groupadd -g 2777 -o -r yhpg >/dev/null 2>&1 || :
useradd -m -g yhpg -o -r -d /home/yhpg -s /bin/bash -c "YHPG Server Administrator" -u 2777 -p yhpg002777 yhpg >/dev/null 2>&1 || :
mkdir -p /var/lib/pgsql || :
chown -R yhpg:yhpg /var/lib/pgsql || :
...
chown yhpg: /var/lib/pgsql/.bash_profile
...
%endif
%else
%attr(700,yhpg,yhpg) %dir /var/lib/pgsql
%endif
%attr(700,yhpg,yhpg) %dir /var/lib/pgsql/%{pgmajorversion}
%attr(700,yhpg,yhpg) %dir /var/lib/pgsql/%{pgmajorversion}/data
%attr(700,yhpg,yhpg) %dir /var/lib/pgsql/%{pgmajorversion}/backups
%attr(755,yhpg,yhpg) %dir /var/run/%{sname}
...
%files test
%defattr(-,yhpg,yhpg)
%attr(-,yhpg,yhpg) %{pgbaseinstdir}/lib/test/*
%attr(-,yhpg,yhpg) %dir %{pgbaseinstdir}/lib/test
%endif

%changelog
* Tue Oct 1 2019 Devrim Gündüz <devrim@gunduz.org> - 12.1-1
- Please welcome PostgreSQL 12.1!
...
* Fri Feb 15 2019 Devrim Gündüz <devrim@gunduz.org> - 12.1-devel
